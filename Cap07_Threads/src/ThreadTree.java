...
public class ThreadTree extends JScrollPane {
	private static ThreadTree instance = null;
	private JTree tree;
	private DefaultTreeModel dtm;

	private ThreadTree() { // construtor privado
	...
	public static final ThreadTree getInstance() {
		if (instance == null) { // verifica instancia
			instance = new ThreadTree(); // cria nova instancia
		}
